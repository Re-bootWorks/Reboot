...
export default function CategoryCard({
	...
	return (
		<article
			...
			<div className="relative z-10 flex size-25 shrink-0 items-center justify-center transition-all duration-400 ease-out group-hover:scale-105 lg:size-35">
				<Image src={image} alt={alt} width={140} height={140} className="size-25 lg:size-35" />
			</div>
			...
			<div className="relative z-10">
				...
				<div className="mt-3 flex flex-col items-center gap-1.5 md:mt-8 md:flex-row md:items-start">
					{tags.map((tag: string) => (
						<span
							key={tag}
