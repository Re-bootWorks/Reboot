	...
	return (
		<div className="w-full rounded-[48px] bg-white px-6 pt-6 pb-5 md:px-10 md:pt-10 md:pb-9 lg:px-16 lg:pt-16 lg:pb-14">
			...
			<div className="flex items-start justify-between">
				...
				<IcMeetBalls size="md" className="cursor-pointer" />
			</div>
			{/* 작성자 */}
			...
			{/* 내용 */}
			<div
				className="mt-6 h-[140px] overflow-hidden text-base leading-6 tracking-[-0.32px] text-gray-700 md:mt-10 md:line-clamp-4 md:h-auto"
